...
- Completed: the single-sidebar UX correction and Markdown note rich-text shortcuts; dark mode is implemented with presentation-only local preference storage.
