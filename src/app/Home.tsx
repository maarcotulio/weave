...
export function HomePage({ stats, activity, onOpenManuscript, onImportProject, importAvailable }: { stats: WritingStats; activity: WritingActivity[]; onOpenManuscript: () => void; onImportProject: () => void; importAvailable: boolean }) {
